...
// ===================================================================================
    ...
    //block 120 * 1 * 1
    //grid  1 * 1 * 64
    __global__ void fc3_sum2out(float *fc1_sum, float* fc1_out){
...
// ===================================================================================
    ...
    dim3 fc3_cublasLt_block(120,1,1), fc3_cublasLt_grid(1,1,64);
    ...
    checkCudaErrors(cublasLtMatrixLayoutCreate(&convdesc, CUDA_R_32F, 120, 16 * 4 * 4, 120));
    checkCudaErrors(cublasLtMatrixLayoutCreate(&outdesc, CUDA_R_32F, 120, 64, 120));
        ...
        {     
            ...
            if(is_graph1_work == false){
                checkCudaErrors(cudaStreamBeginCapture(stream1,cudaStreamCaptureModeGlobal));
                    ...
                    fc3_sum2out<<<fc3_cublasLt_grid,fc3_cublasLt_block,0,stream1>>>(fc1_sum, fc1_out);
        ...
        printf("batch %d -> stream1\n", images_group);
            ...
            if(is_graph2_work == false){
                ...
                for(int Loop_times = 0; Loop_times < total_loop_times; Loop_times ++){
                    ...
                    fc3_sum2out<<<fc3_cublasLt_grid,fc3_cublasLt_block,0,stream2>>>(fc1_sum_2, fc1_out_2);
